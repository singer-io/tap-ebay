...
class EbayRunner:
    ...
    def __init__(self, available_streams):
    ...
    def do_discover(self):
        ...
        for available_stream in self.available_streams:
            ...
            stream = available_stream(None, None)
...
@singer.utils.handle_top_exception(LOGGER)
def main():
    # Skip required config keys when running discovery
    ...
    client = EbayClient()
    runner = EbayRunner(AVAILABLE_STREAMS)
